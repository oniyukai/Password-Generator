...
# tkinter物件
window = tk.Tk()
window.title('密碼生成器 GUI v3.1_23.08.06_zh')
window.geometry('614x253+400+300')
window.resizable(False,False)
window.config(bg='#333333')

tk.Label(text='Version 3.1_23.08.06_zh    Made by YUKAI', bg='#333333', fg='#CCFFF7', font=15).grid(row=0, column=0, columnspan=2)
tk.Label(text=' 輸入生成幾組:', bg='#262626', fg='#ffffff', font=15, width=15, anchor='w').grid(row=1, column=0)
sets_entry = tk.Entry(bg='#ffffff', fg='#000000', font=15, width=20, justify='right')
sets_entry.grid(row=1, column=1)
tk.Label(text=' 輸入密碼的長度:', bg='#262626', fg='#ffffff', font=15, width=15, anchor='w').grid(row=2, column=0)
length_entry = tk.Entry(bg='#ffffff', fg='#000000', font=15, width=20, justify='right')
length_entry.grid(row=2, column=1)

tk.Label(text='包含以下字符:', bg='#262626', fg='#ffffff', font=15, width=35).grid(row=3, column=0, columnspan=2)
